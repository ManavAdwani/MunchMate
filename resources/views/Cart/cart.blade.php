                ...
                <div class="items">
                    ...
                    <div class="left">
                        ...
                        <div class="name" style="display: inline-block;">
                            <p style="font-family: 'Comic Sans MS', cursive; font-size:20px">{{ $product->dish_name }}
                            </p>
                            <p style="font-family: 'Comic Sans MS', cursive; font-size:15px">{{ $product->dish_desc }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="right">
                        ...
                        <a href="{{ route('deleteItem', $product->cartId) }}">
